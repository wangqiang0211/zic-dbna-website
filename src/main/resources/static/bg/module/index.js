    ...
    var index = {
        ...
        loadView: function (param) {
            ...
            if (!flag) {
                ...
                // 记忆选项卡
                if (index.cacheTab) {
                    var indexTabs = admin.getTempData(path+account+'indexTabs');
                    if (!indexTabs) {
                        indexTabs = new Array();
                    }
                    ...
                    if (!isAddCache) {
                        ...
                        admin.putTempData(path+account+'indexTabs', indexTabs);
                    }
                }
            }
            // 切换到该选项卡
        ...
        closeTabCache: function () {
            ...
            admin.putTempData(path+account+'indexTabs', undefined);
        }
    };
